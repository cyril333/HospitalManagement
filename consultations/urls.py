...
urlpatterns = [
    ...
    path('prescription-items/', views.prescription_item_list, name='prescription_item_list'),
    path('prescription-items/add/', views.prescription_item_add, name='prescription_item_add'),
    path('prescription-items/edit/<int:pk>/', views.prescription_item_edit, name='prescription_item_edit'),
    path('prescription-items/delete/<int:pk>/', views.prescription_item_delete, name='prescription_item_delete'),
